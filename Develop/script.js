...
function determinerLength() {
  passwordLength = prompt(
    "Choose how many characters long you'd like your password to be (between 8-128 chaaracters):"
  );
...
function determineSpecial(){
  specialCheck = prompt("Do you want to include special chacarters in your password? \n(Yes or No)"
  );
...
function generatePassword(){
  ...
  }else if (uppercaseChar && numberCheck) {
